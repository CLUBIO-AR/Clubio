...
- Dos planes activos: Basic (USD 28/mes), Multi (USD 75/mes)
- Plan 'Plus' eliminado junio 2026 — gyms legacy con plus siguen activos pero no se vende más
...
- WhatsApp incluido desde plan Multi (el gym conecta su propia cuenta Meta, costo $0 para CLUBIO)
...
## Planes actuales
| Plan  | Precio/mes | Sedes | Admins | WA  | Branding |
|-------|-----------|-------|--------|-----|----------|
| Basic | USD 28    | 1     | 3      | ✗  | ✓       |
| Multi | USD 75    | 5     | 10     | ✓  | ✓       |
